...
public class ItemController {
    ...
    public ItemDto create(@Valid @RequestBody ItemDto itemDto, @RequestHeader(HttpProperties.HEADER_SHARER_USER_ID) Long userId) {
    ...
    public ItemDto patch(@PathVariable Long itemId, @RequestBody ItemDto itemDto,
                             @RequestHeader(HttpProperties.HEADER_SHARER_USER_ID) Long userId) {
    ...
    @GetMapping
    public List<ItemDto> getItems(@RequestHeader(HttpProperties.HEADER_SHARER_USER_ID) Long userId) {
