...
public class BaseClient {
    ...
    protected ResponseEntity<Object> searchItems(String path, Map<String, Object> parameters) {
        return search(path, parameters);
    }

    protected ResponseEntity<Object> search(String path, Map<String, Object> parameters) {
